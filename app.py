    ...
    try:
        ...
        if not os.path.exists(model_path):
            raise FileNotFoundError(
                "best_attention_hybrid_model.pth was not found next to app.py. "
                "Upload it with the app repository, preferably using Git LFS."
            )
